...
class KtorKitDeclarationGenerationExtension(session: FirSession) : FirDeclarationGenerationExtension(session) {
    ...
    private val ktorClientClassId = ClassId(FqName("io.ktorkit"), Name.identifier("KtorClient"))

    private val contributesApiPredicate =
        LookupPredicate.BuilderContext.annotated(FqName("io.ktorkit.ContributesAPI"))
